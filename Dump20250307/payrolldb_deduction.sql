...
CREATE TABLE `deduction` (
  ...
  KEY `pr_id` (`pr_id`),
  CONSTRAINT `deduction_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employee` (`employee_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `deduction_ibfk_2` FOREIGN KEY (`pr_id`) REFERENCES `payroll` (`pr_id`)
...
-- Dump completed on 2025-03-07 10:16:38
